...
def initConfig():
	...
	setCell( "vk_login", "phone" ) # Логин от аккаунта ВК
	setCell( "vk_password", "pass" ) # Пароль от аккаунта ВК

	setCell( "app_id", 2685278 ) # Приложение, у которого есть доступ взаимодействовать с ВК
	setCell( "telegram_token", "TOKENTG" ) # Токен ботинка в Telegram
	...
	setCell( "vk_IDVK", '-CHATID' ) # Пример переадресации ЛС ВК в Telegram
	setCell( "t_-CHATID", 'IDVK' ) # Пример переадресации ЛС ВК в Telegram
